...
class Block{
    constructor(index, prevHash, data, difficulty, timestamp, hash)
    {
        this.index = index
        this.prevHash = prevHash
        this.data = data
        this.timestamp = timestamp != null ? timestamp : new Date().getMilliseconds
        this.hash = hash != null ? hash : this.caculateHash()
